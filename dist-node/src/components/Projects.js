    ...
    return (<section id="projects" className="projects-section ">
      <div className="projects-wrapper">
        ...
        <div className="projects-swiper-container">
          <Swiper modules={[Navigation, Pagination]} slidesPerView={1} loop={true} navigation={{
            ...
            {projects.map((project, index) => (<SwiperSlide key={index} className="project-slide">
                <a href={project.link} target="_blank" rel="noreferrer" className="project-slide-link">
                  <img src={project.img} alt="project preview" className="project-image"/>
