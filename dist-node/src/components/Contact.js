...
const Contact = () => {
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            ...
            <div className="contact__data">
              ...
              <a href="https://api.whatsapp.com/send?phone=9500041579&text=Get in Touch – Let’s Build Something Great!" target="_blank" rel="noopener noreferrer" className="contact__button">
        ...
        <div className="contact__content">
          ...
          <form ref={form} onSubmit={sendEmail} className="contact__form">
            <div className="contact__form-div">
              ...
              <input type="text" name="user_name" id="user_name" required placeholder="Your name" className="contact__form-input"/>
            </div>
            ...
            <div className="contact__form-div">
              ...
              <input type="email" name="user_email" id="user_email" required placeholder="Your email" className="contact__form-input"/>
            </div>
            ...
            <div className="contact__form-div contact__form-area">
              ...
              <textarea name="message" id="message" required placeholder="Ask me something?" className="contact__form-input"></textarea>
            </div>
    ...
    <ToastContainer position="top-center" // center top - easier to see on mobile
     autoClose={2000} hideProgressBar={false} newestOnTop={false} closeOnClick rtl={false} pauseOnFocusLoss draggable pauseOnHover theme="dark"/>
